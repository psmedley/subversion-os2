...
XS(_wrap_svn_fs_file_md5_checksum) {
  {
    ...
    {
      /*@SWIG:/home/dsg/svn_release_1.14.5/prefix/share/swig/3.0.12/perl5/perltypemaps.swg,59,%append_output@*/ if (argvi >= items) EXTEND(sp,1); /*@SWIG:/home/dsg/svn_release_1.14.5/prefix/share/swig/3.0.12/perl5/perltypemaps.swg,56,%set_output@*/ ST(argvi) = sv_2mortal(newSVpv(svn_md5_digest_to_cstring(arg1,
            _global_pool),
          0)); argvi++ /*@SWIG@*/
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/dsg/svn_release_1.14.5/prefix/share/swig/3.0.12/perl5/perltypemaps.swg,65,%set_constant@*/ do {
